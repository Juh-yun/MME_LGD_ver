...
parser.add_argument('--step', type=int, default=1000, metavar='step', help='loading step')
...
parser.add_argument('--dataset', type=str, default='multi', choices=['multi_all'], help='the name of dataset, multi is large scale dataset')
...
G.load_state_dict(torch.load(os.path.join(args.checkpath, "G_iter_model_{}_{}_to_{}_step_{}.pth.tar"
                                          .format(args.method, args.source, args.target, args.step))))
F1.load_state_dict(torch.load(os.path.join(args.checkpath, "F1_iter_model_{}_{}_to_{}_step_{}.pth.tar"
                                           .format(args.method, args.source, args.target, args.step))))
